@echo off
chcp 65001 >nul
REM Installation Menu - เมนูเลือกกาif "%choice%"=="5" (
    ...
    cls
    goto :eof
)ู้ใช้เลือกวิธีการติดตั้งที่เหมาะสม
...
echo.
echo 6️⃣  แก้ปัญหาหลังติดตั้ง Build Tools 🔧 (ใหม่!)
echo     - สำหรับที่ติดตั้ง Build Tools แล้วแต่ยังใช้ไม่ได้
echo     - ตั้งค่า C++ environment ใหม่
echo.
echo 7️⃣  ติดตั้ง C++ Tools แบบสมบูรณ์ 🛠️ (ใหม่!)
echo     - ติดตั้ง Visual Studio Build Tools ทั้งหมด
echo     - รองรับการติดตั้งแบบ step-by-step
echo.
echo 8️⃣  แก้ปัญหา FAISS
echo     - แก้ปัญหา FAISS compatibility
echo.
echo 9️⃣  ติดตั้งแบบอื่นๆ (สำหรับผู้เชี่ยวชาญ)
echo     - วิธีการติดตั้งทางเลือก
echo.
echo 0️⃣  ออกจากเมนู
echo.

set /p choice="เลือกหมายเลข (0-9): "
